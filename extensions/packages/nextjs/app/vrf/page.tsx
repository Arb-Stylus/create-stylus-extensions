...
const ARB_SEPOLIA_CONSUMER_ADDRESS =
  "0xeEA5eC3da1ED9b3479Cb2f0834f4FD918eBCfCC2";
const ARB_MAINNET_CONSUMER_ADDRESS =
...
const VRFPage: NextPage = () => {
  ...
  const {
    writeContractAsync: requestRandomWords,
    isMining: isRequestingRandom,
  } = useScaffoldWriteContract({
      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-base-content/80">
            Verifiable Random Function (VRF) using Stylus Smart Contracts
          </p>
        </div>
        ...
        <div className="alert alert-warning mb-8">
          ...
          <div>
            ...
            <div className="text-xs">
              Chainlink VRF contracts are only available on{" "}
              <strong>Arbitrum Sepolia</strong> and{" "}
              <strong>Arbitrum One</strong>. Make sure you&apos;re connected to
              one of these networks to interact with VRF services.
            </div>
            <div className="text-xs mt-2 p-2 rounded  border-black border">
              <strong>Setup (after you deploy the contracts):</strong> Update
              your{" "}
              ...
              and/or{" "}
              <code className="bg-base-300 px-1 rounded">chains.arbitrum</code>{" "}
              in the{" "}
              <code className="bg-base-300 px-1 rounded">targetNetworks</code>{" "}
              array.
              <br />
              <br />
              <strong>Note:</strong> The VRF Consumer contract is deployed on
              Arbitrum Sepolia and Arbitrum One.
            </div>
          </div>
        </div>
        ...
        <div className="card bg-base-100 shadow-xl mb-8">
          <div className="card-body">
            ...
            <div className="space-y-4 text-sm text-base-content">
              <p>
                <strong>Chainlink VRF (Verifiable Random Function)</strong> is a
                provably fair and verifiable random number generator (RNG) that
                enables smart contracts to access random values without
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-6">
                <div className="bg-base-200 p-4 rounded-lg">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-xs text-base-content">
                    <li>
                      Oracle nodes generate random numbers with cryptographic
                      proof
                    </li>
                    <li>
                      On-chain verification ensures randomness cannot be
                      manipulated
                    </li>
                    <li>
                      Direct funding model allows pay-per-request flexibility
                    </li>
                  </ul>
                </div>
              ...
              {connectedAddress ? (
                ...
                <div className="alert alert-warning">
                  ...
                  <span className="text-xs">
                    Please connect your wallet to request random numbers
                  </span>
                </div>
              )}
            ...
            <div className="card-body">
                  ...
                  <div className="bg-base-200 p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 gap-2 text-xs">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          >
                            {(requestStatus[0]?.toString() || "0").length > 10
                              ? `${(requestStatus[0]?.toString() || "0").slice(
                                  0,
                                  6,
                                )}...${(
                                  requestStatus[0]?.toString() || "0"
                      ...
                      <div className="flex justify-between">
                        ...
                        <span
                          className={`badge ${
                            requestStatus[1] ? "badge-success" : "badge-warning"
                          }`}
                        >
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            >
                              {(requestStatus[2]?.toString() || "").length > 10
                                ? `${(requestStatus[2]?.toString() || "").slice(
                                    0,
                                    6,
                                  )}...${(
                                    requestStatus[2]?.toString() || ""
              ...
              <div className="bg-base-200 p-3 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-1 text-xs text-base-content">
                  ...
                  <li>
                    <strong>Fulfilled:</strong> Whether oracle has provided the
                    random number
                  </li>
                  <li>
                    <strong>Random Word:</strong> The actual random number (if
                    fulfilled)
                  </li>
                </ul>
              </div>
          ...
          <div className="card-body">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-base-200 p-4 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-1 text-xs text-base-content">
                  <li>
                    <code>callWriteRequestRandomNumber</code> - Request random
                    words
                  </li>
                  <li>
                    <code>callViewGetLastRequestId</code> - Get latest request
                    ID
                  </li>
                  <li>
            ...
            <div className="alert alert-info mt-4">
              ...
              <div className="text-xs text-base-content">
                ...
                <p>
                  This page demonstrates how to integrate Chainlink VRF with
                  Arbitrum Stylus contracts. The Rust contract acts as a proxy
                  to interact with Chainlink&apos;s Direct Funding Consumer
                  contract. Check out the source code in{" "}
                  <code>packages/stylus/vrf-consumer/src/lib.rs</code>
                </p>
              </div>
            </div>
          </div>
